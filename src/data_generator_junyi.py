...
def get_dataloader_junyi(data_path="junyi", batch_size=128, num_workers=8, seq_len=64,center_node=True):
...
def get_dataloader_junyi_part(data_path='junyi_part', batch_size=128, num_workers=8, seq_len=64,
                        center_node=True):
